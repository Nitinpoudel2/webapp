...
const ExpenseDetails = () => {
  ...
  return (
    <div className="container mt-2">
          ...
          <table className="table table-borderless table-responsive">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  {expense
                    ? CurrencyUtils.formatToDollar(parseFloat(expense.amount))
                    : "N/A"}
                </td>
              </tr>
              <tr>
      ...
      <ConfirmDialog show = {showDialog} title="Confirm Delete" message="Are you sure you want to delete this item" onCancel={handleCancel} onConfirm={handleConfirm} />
    </div>
  );
};
